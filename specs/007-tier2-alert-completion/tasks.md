...
- [ ] T001 Create feature branch `007-tier2-alert-completion` from `main`; its first commit is the 007 design artifacts currently uncommitted on `main` (`specs/007-tier2-alert-completion/`, constitution v1.2.3, the `CLAUDE.md` plan pointer, `.specify/feature.json`)
